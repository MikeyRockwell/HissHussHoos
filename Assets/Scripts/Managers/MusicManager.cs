...
namespace Managers
{
    public class MusicManager : MonoBehaviour
    {
        ...
        private void Forward()
        {
            ...
            if (md.currentTrackIndex == gd.musicData.musicTracks.Length) md.currentTrackIndex = 0;
            PlayMusicTrack(md.musicTracks[md.currentTrackIndex]);
        }
        ...
        {
            md.currentTrackIndex--;
            if (md.currentTrackIndex < 0) md.currentTrackIndex = gd.musicData.musicTracks.Length - 1;
            PlayMusicTrack(md.musicTracks[md.currentTrackIndex]);
        }
